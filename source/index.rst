...
This is achieved by using scalable implementations of the ROM algorithms, and by using `Dask <https://www.dask.org/>`__ as a backend for out-of-core parallel computing.
